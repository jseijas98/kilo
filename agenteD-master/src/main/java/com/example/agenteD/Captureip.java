...
public class Captureip {
    ...
    public static final String COMAND = "ping";
    public static final String ESPACIO = " ";
    public static final String IP_HOST = "www.google.com";
    ...
    public static void main( String[] argumentos ){
        ...
        Captureip javaPing = new Captureip();
...
//Validacion IP.
    ...
    public void validarPingIP( String IP ){
        ...
        String mensaje = null;
        String pingCMD = COMAND + ESPACIO + IP;
